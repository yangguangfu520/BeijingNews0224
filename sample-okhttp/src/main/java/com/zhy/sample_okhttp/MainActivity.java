...
public class MainActivity extends AppCompatActivity
{
    ...
    public void postFile(View view)
    {
        ...
        //http://localhost:8080/FileUpload/index.jsp 代表的是首页
        //文件服务器
        String url = "http://192.168.31.168:8080/FileUpload/FileUploadServlet";//真难的难点
        OkHttpUtils
                .postFile()//post请求
                .url(url)
                .file(file)
...
//        url =3.125.219.144:8443/mobileConnect/MobileConnect/authLogin.action?systemid=100009&mobile=13260284063&pipe=2&reqtime=1422986580048&ispin=2";
    ...
    public void uploadFile(View view)
    {
        ...
        OkHttpUtils.post()//
                .addFile("mFile", "atguigu.gif", file)//
                .url(url)//
                .params(params)//
                .headers(headers)//
                .build()//
    ...
    {
        File file = new File(Environment.getExternalStorageDirectory(), "logo.gif");
        File file2 = new File(Environment.getExternalStorageDirectory(), "mm.jpg");
        if (!file.exists())
        {
            Toast.makeText(MainActivity.this, "文件不存在，请修改文件路径", Toast.LENGTH_SHORT).show();
            return;
        ...
        Map<String, String> params = new HashMap<>();
//        params.put("username", "atgugiu");
//        params.put("password", "123");

        String url = "http://192.168.31.168:8080/FileUpload/FileUploadServlet";//真难的难点
        OkHttpUtils.post()//
                .addFile("mFile", "logo.gif", file)//
                .addFile("mFile", "mm.jpg", file2)//
                .url(url)
                .params(params)//
                .build()//
                .execute(new MyStringCallback());
